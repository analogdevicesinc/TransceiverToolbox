...
def gen_rd_svg():
    ...
    assets_folder = os.path.join(folder_of_this_file, "..", "source", "_static", "assets")
    stylesheets_folder = os.path.join(folder_of_this_file, "..", "source", "_static", "css")
    ...
    for ref in refs:
        ...
        print("Generating svg for", ref)

        with open(os.path.join(assets_folder,f"{ref}.svg"), "r") as f:
            svg = f.read()
        ...
        with open(os.path.join(assets_folder,f"{ref}_custom.svg"), "w") as f:
            f.write(output)
    ...
    print("Writing css")
    with open(os.path.join(stylesheets_folder,"rd_style.css"), "w") as f:
        f.write(css_out)
