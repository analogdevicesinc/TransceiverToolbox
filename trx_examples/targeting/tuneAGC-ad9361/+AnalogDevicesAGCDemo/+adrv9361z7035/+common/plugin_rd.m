...
hRD.addParameter( ...
    'ParameterID',   'postprocess_script', ...
    'DisplayName',   'Postprocess Script', ...
    'DefaultValue',  fullfile('trx_examples', 'targeting', 'tuneAGC-ad9361', 'ccfmc_lvds_agc','tune_agc_postprocess.tcl'));
