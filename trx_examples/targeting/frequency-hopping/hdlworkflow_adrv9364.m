...
hdlset_param('frequency_hopping', 'ReferenceDesign', 'ADRV9364 CCBOB_LVDS_HOP (Rx & Tx)');
hdlset_param('frequency_hopping', 'SynthesisTool', 'Xilinx Vivado');
hdlset_param('frequency_hopping', 'SynthesisToolChipFamily', 'Zynq');
hdlset_param('frequency_hopping', 'SynthesisToolDeviceName', 'xc7z020');
hdlset_param('frequency_hopping', 'SynthesisToolPackageName', 'clg400');
hdlset_param('frequency_hopping', 'SynthesisToolSpeedValue', '-1');
hdlset_param('frequency_hopping', 'TargetDirectory', 'hdl_prj/hdlsrc');
hdlset_param('frequency_hopping', 'TargetLanguage', 'Verilog');
hdlset_param('frequency_hopping', 'TargetPlatform', 'AnalogDevices ADRV9364-Z7020 Frequency Hopping');
