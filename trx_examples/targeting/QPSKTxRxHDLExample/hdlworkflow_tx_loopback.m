%--------------------------------------------------------------------------
% HDL Workflow Script
% Generated with MATLAB 25.2 (R2025b) at 12:29:43 on 20/05/2026
% This script was generated using the following parameter values:
%     Filename  : 'C:\work\datalink\TransceiverToolbox\trx_examples\targeting\QPSKTxRxHDLExample\hdlworkflow_tx_loopback.m'
%     Overwrite : true
%     Comments  : true
%     Headers   : true
...
hdlset_param('commhdlQPSKTxRx/Transmitter/dataOutI', 'IOInterface', 'IP Data 0 OUT [0:15]');
hdlset_param('commhdlQPSKTxRx/Transmitter/dataOutI', 'IOInterfaceMapping', '[0:15]');

% Set Outport HDL parameters
hdlset_param('commhdlQPSKTxRx/Transmitter/dataOutQ', 'IOInterface', 'IP Data 1 OUT [0:15]');
...
% Set Outport HDL parameters
hdlset_param('commhdlQPSKTxRx/Transmitter/validOut', 'IOInterface', 'IP Data Valid OUT');
