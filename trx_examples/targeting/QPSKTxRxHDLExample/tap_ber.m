...
% Receiver's post-carrier-sync tap (iq_debug_mux=2 -> debugI1/Q1 -> rx DMA)
...
wr('0x9D000118',1); wr('0x9D000114',1); wr('0x9D00010C',2);   % tap2 = post-CS
...
z=double(y)/2^14; save('tap2_capture.mat','z');
