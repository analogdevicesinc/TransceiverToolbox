%==========================================================================
% hdlworkflow_txrx.m  --  TX RX & TX variant RX variant of the QPSK Receiver HDL workflow
%
% Same DUT (commhdlQPSKTxRx/Receiver) and port mappings as
% hdlworkflow_rx_debug.m, but targets the JUPITER (RX & TX - TX IS FASTER ...)
...
%
% Builds into hdl_prj_jupiter_txrx/ (separate from the RX build). rstCS is
...
hdlset_param('commhdlQPSKTxRx', 'ProjectFolder', 'hdl_prj_jupiter_txrx');
hdlset_param('commhdlQPSKTxRx', 'ReferenceDesign', 'JUPITER (TX & RX - TX IS FASTER OR HAS PRIORITY)');
hdlset_param('commhdlQPSKTxRx', 'ReferenceDesignParameter', {'project','jupiter_sdr','ref_design','txrx','preprocess','off','postprocess','off','number_of_inputs','4','number_of_bits','16','number_of_valids','1','multiple','1','HDLVerifierAXI','off','HDLVerifierFDC','JTAG'});
...
hdlset_param('commhdlQPSKTxRx', 'TargetDirectory', 'hdl_prj_jupiter_txrx/hdlsrc');
...
hWC.ProjectFolder = 'hdl_prj_jupiter_txrx';
