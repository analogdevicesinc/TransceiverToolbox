% rx_thr_20: lower the preamble-detection threshold to 0.2x (acquire the
...
set_param(thr,'Gain','fi(ThresoldGainFac*0.2,0,16,16)');
fprintf('rx_thr_20: preamble threshold x0.2\n');
