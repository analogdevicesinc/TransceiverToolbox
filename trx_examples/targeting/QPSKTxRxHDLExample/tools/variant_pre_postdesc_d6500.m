% V29_postdesc_d6500: same tap as V23 (post-Descrambler dataOut, V16
...
if ~isempty(find_system(loop,'SearchDepth',1,'BlockType','Outport','Name','capture_word_out'))
    fprintf('V29 already instrumented; skipping insertions.\n');
...
if isempty(find_system(rx,'SearchDepth',1,'Name','BitCapture'))
    ...
    bcLines = { ...
        ...
        '% count dstart pulses; arm on the 6500th (~3 ms past boot at' ...
    ...
    fprintf('V29_postdesc_d6500 insertion complete.\n');
end
