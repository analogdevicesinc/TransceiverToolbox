...
in_byte = { 'byte_data','uint64','1/30.72e6'; 'byte_valid','boolean','1/30.72e6'; ...
            'tx_data_source','uint32','1/15.36e6' };
...
'function [word, avail, readyNext] = byteWordBufferBlk(dataIn, validIn, popReq)\n' ...
...
'end\n' ...
'[word, avail, ~, state] = qpskByteWordBuffer(state, uint64(dataIn), ...\n' ...
'    logical(validIn), logical(popReq));\n' ...
...
% head word/avail: 30.72M -> 7.68M into the Transmitter byte ports
