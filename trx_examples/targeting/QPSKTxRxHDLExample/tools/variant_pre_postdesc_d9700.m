% V34_postdesc_d9700: same tap as V23 (post-Descrambler dataOut, V16
...
if ~isempty(find_system(loop,'SearchDepth',1,'BlockType','Outport','Name','capture_word_out'))
    fprintf('V34 already instrumented; skipping insertions.\n');
...
if isempty(find_system(rx,'SearchDepth',1,'Name','BitCapture'))
    ...
    fprintf('V34_postdesc_d9700 insertion complete.\n');
end
