classdef HardwarePostCSIQV3Test < matlab.unittest.TestCase
%HARDWAREPOSTCSIQV3TEST  Read 64 complex post-Carrier-Sync symbols captured
...
%   Output:   capture_word_out @ 0x9D00011C (32-bit word {I[31:16],Q[15:0]})
    ...
    methods (Test, TestTags = {'Hardware'})
        function decodePostCSV3(testCase)
            ...
            fid = fopen(fullfile(outDir,'postCSIQ_v3.json'),'w');
