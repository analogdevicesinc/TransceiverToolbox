classdef HardwarePostDescD3000Test < matlab.unittest.TestCase
%HARDWAREPOSTDESCD3000TEST  Read the V_3000_pkt 1024-bit buffer
%   via AXI4-Lite. Tap is POST-Descrambler dataOut (same as V16/V23),
%   arm delayed to the 101st dstart pulse (packet 3000).
...
%   Output:   capture_word_out @ 0x9D00011C (32-bit word, 32 = 1024 bits)
    ...
    methods (Test, TestTags = {'Hardware'})
        function decodePostDescD3000(testCase)
            ...
            fprintf('\n=== V25-27 post-Descrambler decode (~packet 100, early steady-state) ===\n');
            ...
            fid = fopen(fullfile(outDir,'postDescD3000.json'),'w');
