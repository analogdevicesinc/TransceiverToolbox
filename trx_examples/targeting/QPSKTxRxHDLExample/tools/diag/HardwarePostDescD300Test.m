classdef HardwarePostDescD300Test < matlab.unittest.TestCase
%HARDWAREPOSTDESCD300TEST  Read the V_300_pkt 1024-bit buffer
%   via AXI4-Lite. Tap is POST-Descrambler dataOut (same as V16/V23),
%   arm delayed to the 101st dstart pulse (packet 300).
...
%   Output:   capture_word_out @ 0x9D00011C (32-bit word, 32 = 1024 bits)
    ...
    methods (Test, TestTags = {'Hardware'})
        function decodePostDescD300(testCase)
            ...
            fid = fopen(fullfile(outDir,'postDescD300.json'),'w');
