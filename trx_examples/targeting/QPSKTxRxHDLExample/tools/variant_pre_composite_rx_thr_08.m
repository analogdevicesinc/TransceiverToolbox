% rx_thr_08: lower the preamble-detection threshold to 0.08x (acquire the
...
set_param(thr,'Gain','fi(ThresoldGainFac*0.08,0,16,16)');
fprintf('rx_thr_08: preamble threshold x0.08\n');
