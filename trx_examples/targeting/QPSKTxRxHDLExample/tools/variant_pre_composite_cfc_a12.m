% cfc_a12: shorten the Coarse Frequency Estimator averaging window to 2^12
...
assert(contains(get_param(qrx,'MaskInitialization'),'integAvgLen = 2^12;'),'overlay failed');
fprintf('cfc_a12: Coarse Frequency Estimator integAvgLen 2^15 -> 2^12 (%d sym)\n', 2^12);
