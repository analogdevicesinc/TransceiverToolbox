% V25_postdesc_d300: same tap as V23 (post-Descrambler dataOut, V16
...
if ~isempty(find_system(loop,'SearchDepth',1,'BlockType','Outport','Name','capture_word_out'))
    fprintf('V25_postdesc already instrumented; skipping insertions.\n');
...
if isempty(find_system(rx,'SearchDepth',1,'Name','BitCapture'))
    ...
    bcLines = { ...
        ...
        '% count dstart pulses; arm on the 300th (~10 ms past boot at' ...
    ...
    fprintf('V25_postdesc_d300 insertion complete.\n');
end
