classdef HardwarePostDescD9900Test < matlab.unittest.TestCase
%HARDWAREPOSTDESCD9900TEST  Read the V24_postdesc_d100 1024-bit buffer
...
%   Output:   capture_word_out @ 0x9D00011C (32-bit word, 32 = 1024 bits)
    ...
    methods (Test, TestTags = {'Hardware'})
        function decodePostDescD9900(testCase)
            ...
            fid = fopen(fullfile(outDir,'postDescD9900.json'),'w');
