// -------------------------------------------------------------
// 
// File Name: hdl_prj_jupiter_txrx/hdlsrc/commhdlQPSKTxRx/Receiver_ip_src_WaveformGen.v
...
module Receiver_ip_src_WaveformGen
  ...
  Receiver_ip_src_CosLookUpTableGen u_Cos_Wave_inst (.clk(clk),
                                                     .reset(reset),
                                                     .enb_1_2_0(enb_1_2_0),
  ...
  Receiver_ip_src_SinLookUpTableGen u_Sin_Wave_inst (.clk(clk),
                                                     .reset(reset),
                                                     .enb_1_2_0(enb_1_2_0),
                                                     .lutaddr(lutaddrO),  // ufix11
...
endmodule  // Receiver_ip_src_WaveformGen
