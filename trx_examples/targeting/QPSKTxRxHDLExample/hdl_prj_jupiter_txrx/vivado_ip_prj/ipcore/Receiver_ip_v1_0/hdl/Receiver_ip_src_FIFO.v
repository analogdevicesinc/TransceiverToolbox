// -------------------------------------------------------------
// 
// File Name: hdl_prj_jupiter_txrx/hdlsrc/commhdlQPSKTxRx/Receiver_ip_src_FIFO.v
...
// -------------------------------------------------------------
// 
// Module: Receiver_ip_src_FIFO
// Source Path: commhdlQPSKTxRx/Receiver/QPSK Rx/Frequency and Time Synchronizer/Preamble Detector/FIFO
// Hierarchy Level: 4
...
module Receiver_ip_src_FIFO
  ...
  reg [10:0] Push_Counter_out1;  // ufix11
  ...
  wire [10:0] count_from_1;  // ufix11
  wire [10:0] count_reset_1;  // ufix11
  reg [10:0] Pop_Counter_out1;  // ufix11
  wire [10:0] count_3;  // ufix11
  wire need_to_wrap_1;
  wire [10:0] count_value_1;  // ufix11
  ...
  Receiver_ip_src_Validate_Input_Push_Pop u_Validate_Input_Push_Pop (.clk(clk),
                                                                     .reset(reset),
                                                                     .enb_1_2_0(enb_1_2_0),
                                                                     .rst(reset_1),
                                                                     .push(push),
  ...
  assign need_to_wrap = Push_Counter_out1 == 11'b10001101100;
  ...
  always @(posedge clk or posedge reset)
    begin : Push_Counter_process
      if (reset == 1'b1) begin
        Push_Counter_out1 <= 11'b00000000000;
      end
      else begin
        if (enb_1_2_0) begin
  ...
  assign count_from_1 = 11'b00000000000;

  assign count_reset_1 = 11'b00000000000;

  assign count_3 = Pop_Counter_out1 + count_step_1;

  assign need_to_wrap_1 = Pop_Counter_out1 == 11'b10001101100;
  ...
  always @(posedge clk or posedge reset)
    begin : Pop_Counter_process
      if (reset == 1'b1) begin
        Pop_Counter_out1 <= 11'b00000000000;
      end
      else begin
        if (enb_1_2_0) begin
  ...
  Receiver_ip_src_SimpleDualPortRAM_generic #(.AddrWidth(11),
                                              .DataWidth(16)
                                              )
...
endmodule  // Receiver_ip_src_FIFO
