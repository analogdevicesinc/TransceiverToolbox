...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PARALLEL_OR_SERIAL_N" -parent ${Page_0}
...
proc update_PARAM_VALUE.PARALLEL_OR_SERIAL_N { PARAM_VALUE.PARALLEL_OR_SERIAL_N } {
	# Procedure called to update PARALLEL_OR_SERIAL_N when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PARALLEL_OR_SERIAL_N { PARAM_VALUE.PARALLEL_OR_SERIAL_N } {
	# Procedure called to validate PARALLEL_OR_SERIAL_N
	return true
}
...
proc update_MODELPARAM_VALUE.PARALLEL_OR_SERIAL_N { MODELPARAM_VALUE.PARALLEL_OR_SERIAL_N PARAM_VALUE.PARALLEL_OR_SERIAL_N } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PARALLEL_OR_SERIAL_N}] ${MODELPARAM_VALUE.PARALLEL_OR_SERIAL_N}
}
