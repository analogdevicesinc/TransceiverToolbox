...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SPI0_REF_CTRL_DIVISOR0                          0xa
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E007C, 0x013F3F07U ,0x01010A02U)
    */
...
/*##################################################################### */
    ...
    * only.
    *  PSU_DDRC_INIT6_MR5                                          0x6c1

    * SDRAM Initialization Register 6
    * (OFFSET, MASK, VALUE)      (0XFD0700E8, 0xFFFFFFFFU ,0x000006C1U)
    */
	PSU_Mask_Write(DDRC_INIT6_OFFSET, 0xFFFFFFFFU, 0x000006C1U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070100, 0x7F3F7F3FU ,0x0F132311U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG0_OFFSET, 0x7F3F7F3FU, 0x0F132311U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x00060419U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG1_OFFSET, 0x001F1F7FU, 0x00060419U);
/*##################################################################### */
    ...
    * : clocks
    *  PSU_DDRC_DRAMTMG2_READ_LATENCY                              0xa
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070108, 0x3F3F3F3FU ,0x080A0710U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG2_OFFSET, 0x3F3F3F3FU, 0x080A0710U);
/*##################################################################### */
    ...
    *  PSU_DDRC_DRAMTMG3_T_MOD                                     0xe

    * SDRAM Timing Register 3
    * (OFFSET, MASK, VALUE)      (0XFD07010C, 0x3FF3F3FFU ,0x0050E00EU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG3_OFFSET, 0x3FF3F3FFU, 0x0050E00EU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070114, 0x0F0F3F1FU ,0x06080403U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG5_OFFSET, 0x0F0F3F1FU, 0x06080403U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD07011C, 0x00000F0FU ,0x00000806U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG7_OFFSET, 0x00000F0FU, 0x00000806U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070124, 0x40070F3FU ,0x0002030DU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG9_OFFSET, 0x40070F3FU, 0x0002030DU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_DFITMG0_DFI_T_RDDATA_EN                            0xf
    ...
    *  PSU_DDRC_DFITMG0_DFI_TPHY_WRLAT                             0xc

    * DFI Timing Register 0
    * (OFFSET, MASK, VALUE)      (0XFD070190, 0x1FBFBF3FU ,0x048F820CU)
    */
	PSU_Mask_Write(DDRC_DFITMG0_OFFSET, 0x1FBFBF3FU, 0x048F820CU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_DFITMG2_DFI_TPHY_RDCSLAT                           0xd
    ...
    * cification for correct value.
    *  PSU_DDRC_DFITMG2_DFI_TPHY_WRCSLAT                           0xa

    * DFI Timing Register 2
    * (OFFSET, MASK, VALUE)      (0XFD0701B4, 0x00003F3FU ,0x00000D0AU)
    */
	PSU_Mask_Write(DDRC_DFITMG2_OFFSET, 0x00003F3FU, 0x00000D0AU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_DTPR1_TMRD                                      0x1c

    * DRAM Timing Parameters Register 1
    * (OFFSET, MASK, VALUE)      (0XFD080114, 0xFFFFFFFFU ,0x2825041CU)
    */
	PSU_Mask_Write(DDR_PHY_DTPR1_OFFSET, 0xFFFFFFFFU, 0x2825041CU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_DTPR4_TXP                                       0xb

    * DRAM Timing Parameters Register 4
    * (OFFSET, MASK, VALUE)      (0XFD080120, 0xFFFFFFFFU ,0x01702B0BU)
    */
	PSU_Mask_Write(DDR_PHY_DTPR4_OFFSET, 0xFFFFFFFFU, 0x01702B0BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Write Latency
    *  PSU_DDR_PHY_DTPR6_PUBWL                                     0xf

    * Reserved. Return zeroes on reads.
    *  PSU_DDR_PHY_DTPR6_RESERVED_7_6                              0x0

    * Read Latency
    *  PSU_DDR_PHY_DTPR6_PUBRL                                     0x13

    * DRAM Timing Parameters Register 6
    * (OFFSET, MASK, VALUE)      (0XFD080128, 0xFFFFFFFFU ,0x00000F13U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR6_OFFSET, 0xFFFFFFFFU, 0x00000F13U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_MR5_CAPM                                        0x1

    * DDR4 Mode Register 5
    * (OFFSET, MASK, VALUE)      (0XFD080194, 0xFFFFFFFFU ,0x000006C1U)
    */
	PSU_Mask_Write(DDR_PHY_MR5_OFFSET, 0xFFFFFFFFU, 0x000006C1U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_18_L3_SEL                              4

    * Configures MIO Pin 18 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180048, 0x000000FEU ,0x00000080U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_18_OFFSET, 0x000000FEU, 0x00000080U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_21_L3_SEL                              4

    * Configures MIO Pin 21 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180054, 0x000000FEU ,0x00000080U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_21_OFFSET, 0x000000FEU, 0x00000080U);
/*##################################################################### */
    ...
    * sed
    *  PSU_IOU_SLCR_MIO_PIN_22_L3_SEL                              4

    * Configures MIO Pin 22 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180058, 0x000000FEU ,0x00000080U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_22_OFFSET, 0x000000FEU, 0x00000080U);
/*##################################################################### */
    ...
    * TTC Waveform Clock) 6= ua0, Output, ua0_txd- (UART transmitter serial ou
    * tput) 7= Not Used
    *  PSU_IOU_SLCR_MIO_PIN_23_L3_SEL                              4

    * Configures MIO Pin 23 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF18005C, 0x000000FEU ,0x00000080U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_23_OFFSET, 0x000000FEU, 0x00000080U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x50020000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFFFU, 0x50020000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL4_PULL_HIGH_LOW_N_BIT_19             0

    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL4_PULL_HIGH_LOW_N_BIT_20             0

    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL4_PULL_HIGH_LOW_N_BIT_21             0

    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL4_PULL_HIGH_LOW_N_BIT_22             0
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18017C, 0x03FFFFFFU ,0x0387FFFFU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK2_CTRL4_OFFSET,
		0x03FFFFFFU, 0x0387FFFFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(4,0,4,0,2,3,3,0);
