...
#ifndef _system_bit_concatenator_shifter_1_core_h_
#define _system_bit_concatenator_shifter_1_core_h_
...
class system_bit_concatenator_shifter_1_core : public sc_module 
{
    public: 
       system_bit_concatenator_shifter_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(system_bit_concatenator_shifter_1_core);
    ...
    virtual ~system_bit_concatenator_shifter_1_core() = default;
