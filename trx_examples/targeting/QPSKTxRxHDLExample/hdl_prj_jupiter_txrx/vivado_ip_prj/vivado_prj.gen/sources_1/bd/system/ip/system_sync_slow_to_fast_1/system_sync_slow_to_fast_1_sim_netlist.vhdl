...
-- Command     : write_vhdl -force -mode funcsim -rename_top system_sync_slow_to_fast_1 -prefix
--               system_sync_slow_to_fast_1_ system_sync_slow_to_fast_0_sim_netlist.vhdl
...
entity system_sync_slow_to_fast_1_sync_slow_to_fast is
  port (
...
end system_sync_slow_to_fast_1_sync_slow_to_fast;

architecture STRUCTURE of system_sync_slow_to_fast_1_sync_slow_to_fast is
...
entity system_sync_slow_to_fast_1 is
  ...
  attribute NotValidForBitStream of system_sync_slow_to_fast_1 : entity is true;
  ...
  attribute X_CORE_INFO of system_sync_slow_to_fast_1 : entity is "sync_slow_to_fast,Vivado 2025.1";
end system_sync_slow_to_fast_1;

architecture STRUCTURE of system_sync_slow_to_fast_1 is
begin
inst: entity work.system_sync_slow_to_fast_1_sync_slow_to_fast
     port map (
      in_clk => in_clk,
