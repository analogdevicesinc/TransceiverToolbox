...
module sync_input_imp_13CLUWH
   (data_in_rx_0,
    ...
    tx_clk,
    tx_rstn);
  input [15:0]data_in_rx_0;
  input [15:0]data_in_rx_1;
  input [15:0]data_in_rx_2;
  input [15:0]data_in_rx_3;
  input [15:0]data_in_tx_0;
  input [15:0]data_in_tx_1;
  input [15:0]data_in_tx_2;
  input [15:0]data_in_tx_3;
  output [15:0]data_out_rx_0;
  output [15:0]data_out_rx_1;
  output [15:0]data_out_rx_2;
  output [15:0]data_out_rx_3;
  output [15:0]data_out_tx_0;
  output [15:0]data_out_tx_1;
  output [15:0]data_out_tx_2;
  output [15:0]data_out_tx_3;
  input data_valid_in_rx_0;
  input data_valid_in_tx_0;
  output [0:0]data_valid_out_rx_0;
  output [0:0]data_valid_out_tx_0;
  input rx_clk;
  input rx_rstn;
  input tx_clk;
  input tx_rstn;

  wire [64:0]bit_concatenator_shifter_dout;
  wire [64:0]bit_concatenator_sync_dout;
  wire [15:0]data_in_rx_0;
  wire [15:0]data_in_rx_1;
  wire [15:0]data_in_rx_2;
  wire [15:0]data_in_rx_3;
  wire [15:0]data_in_tx_0;
  wire [15:0]data_in_tx_1;
  wire [15:0]data_in_tx_2;
  wire [15:0]data_in_tx_3;
  wire [15:0]data_out_rx_0;
  wire [15:0]data_out_rx_1;
  wire [15:0]data_out_rx_2;
  wire [15:0]data_out_rx_3;
  wire [15:0]data_out_tx_0;
  wire [15:0]data_out_tx_1;
  wire [15:0]data_out_tx_2;
  wire [15:0]data_out_tx_3;
  wire data_valid_in_rx_0;
  wire data_valid_in_tx_0;
  wire [0:0]data_valid_out_rx_0;
  wire [0:0]data_valid_out_tx_0;
  wire rx_clk;
  wire rx_rstn;
  wire [64:0]sync_slow_to_fast_out_data;
  wire tx_clk;
  wire tx_rstn;
  wire [64:0]util_delay_dout;

  system_bit_concatenator_shifter_0 bit_concatenator_shifter
       (.In0(data_in_tx_0),
        .In1(data_in_tx_1),
        .In2(data_in_tx_2),
        .In3(data_in_tx_3),
        .In4(data_valid_in_tx_0),
        .dout(bit_concatenator_shifter_dout));
  system_bit_concatenator_sync_0 bit_concatenator_sync
       (.In0(data_in_rx_0),
        .In1(data_in_rx_1),
        .In2(data_in_rx_2),
        .In3(data_in_rx_3),
        .In4(data_valid_in_rx_0),
        .dout(bit_concatenator_sync_dout));
  system_bit_slicer_rx_0_0 bit_slicer_rx_0
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_out_rx_0));
  system_bit_slicer_rx_1_0 bit_slicer_rx_1
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_out_rx_1));
  system_bit_slicer_rx_2_0 bit_slicer_rx_2
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_out_rx_2));
  system_bit_slicer_rx_3_0 bit_slicer_rx_3
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_out_rx_3));
  system_bit_slicer_tx_0_0 bit_slicer_tx_0
       (.Din(util_delay_dout),
        .Dout(data_out_tx_0));
  system_bit_slicer_tx_1_0 bit_slicer_tx_1
       (.Din(util_delay_dout),
        .Dout(data_out_tx_1));
  system_bit_slicer_tx_2_0 bit_slicer_tx_2
       (.Din(util_delay_dout),
        .Dout(data_out_tx_2));
  system_bit_slicer_tx_3_0 bit_slicer_tx_3
       (.Din(util_delay_dout),
        .Dout(data_out_tx_3));
  system_bit_slicer_valid_rx_0_0 bit_slicer_valid_rx_0
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_valid_out_rx_0));
  system_bit_slicer_valid_tx_0_0 bit_slicer_valid_tx_0
       (.Din(util_delay_dout),
        .Dout(data_valid_out_tx_0));
  system_sync_slow_to_fast_0 sync_slow_to_fast
       (.in_clk(rx_clk),
        .in_data(bit_concatenator_sync_dout),
        .in_resetn(rx_rstn),
        .out_clk(tx_clk),
        .out_data(sync_slow_to_fast_out_data),
        .out_resetn(tx_rstn));
  system_util_delay_0 util_delay
       (.clk(tx_clk),
        .din(bit_concatenator_shifter_dout),
        .dout(util_delay_dout),
        .rstn(tx_rstn));
endmodule

module sync_output_imp_1NKHJQ6
   (data_in_rx_0,
    data_in_rx_1,
    data_in_rx_2,
    data_in_rx_3,
  ...
  system_bit_concatenator_shifter_1 bit_concatenator_shifter
       (.In0(data_in_tx_0),
        .In1(data_in_tx_1),
        .In2(data_in_tx_2),
        .In3(data_in_tx_3),
        .In4(data_valid_in_tx_0),
        .dout(bit_concatenator_shifter_dout));
  system_bit_concatenator_sync_1 bit_concatenator_sync
       (.In0(data_in_rx_0),
        .In1(data_in_rx_1),
        .In2(data_in_rx_2),
        .In3(data_in_rx_3),
        .In4(data_valid_in_rx_0),
        .dout(bit_concatenator_sync_dout));
  system_bit_slicer_rx_0_1 bit_slicer_rx_0
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_out_rx_0));
  system_bit_slicer_rx_1_1 bit_slicer_rx_1
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_out_rx_1));
  system_bit_slicer_rx_2_1 bit_slicer_rx_2
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_out_rx_2));
  system_bit_slicer_rx_3_1 bit_slicer_rx_3
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_out_rx_3));
  system_bit_slicer_tx_0_1 bit_slicer_tx_0
       (.Din(util_delay_dout),
        .Dout(data_out_tx_0));
  system_bit_slicer_tx_1_1 bit_slicer_tx_1
       (.Din(util_delay_dout),
        .Dout(data_out_tx_1));
  system_bit_slicer_tx_2_1 bit_slicer_tx_2
       (.Din(util_delay_dout),
        .Dout(data_out_tx_2));
  system_bit_slicer_tx_3_1 bit_slicer_tx_3
       (.Din(util_delay_dout),
        .Dout(data_out_tx_3));
  system_bit_slicer_valid_rx_0_1 bit_slicer_valid_rx_0
       (.Din(sync_slow_to_fast_out_data),
        .Dout(data_valid_out_rx_0));
  system_bit_slicer_valid_tx_0_1 bit_slicer_valid_tx_0
       (.Din(util_delay_dout),
        .Dout(data_valid_out_tx_0));
  system_sync_slow_to_fast_1 sync_slow_to_fast
       (.in_clk(tx_clk),
        .in_data(bit_concatenator_sync_dout),
        .in_resetn(tx_rstn),
        .out_clk(rx_clk),
        .out_data(sync_slow_to_fast_out_data),
        .out_resetn(rx_rstn));
  system_util_delay_1 util_delay
       (.clk(tx_clk),
        .din(bit_concatenator_shifter_dout),
        .dout(util_delay_dout),
        .rstn(tx_rstn));
...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=56,numReposBlks=54,numNonXlnxBlks=16,numHierBlks=2,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (gpio_i,
    gpio_o,
    gpio_rx1_enable_in,
  ...
  wire [0:0]GND_1_dout;
  wire [15:0]Receiver_ip_0_dut_data_out_0_rx;
  wire [15:0]Receiver_ip_0_dut_data_out_1_rx;
  wire [15:0]Receiver_ip_0_dut_data_out_2_rx;
  wire [15:0]Receiver_ip_0_dut_data_out_3_rx;
  wire Receiver_ip_0_dut_data_valid_out_rx;
  wire [0:0]VCC_1_dout;
  ...
  wire [15:0]axi_hpm0_lpd_interconnect_M07_AXI_ARADDR;
  wire axi_hpm0_lpd_interconnect_M07_AXI_ARREADY;
  wire axi_hpm0_lpd_interconnect_M07_AXI_ARVALID;
  wire [15:0]axi_hpm0_lpd_interconnect_M07_AXI_AWADDR;
  wire axi_hpm0_lpd_interconnect_M07_AXI_AWREADY;
  wire axi_hpm0_lpd_interconnect_M07_AXI_AWVALID;
  wire axi_hpm0_lpd_interconnect_M07_AXI_BREADY;
  wire [1:0]axi_hpm0_lpd_interconnect_M07_AXI_BRESP;
  wire axi_hpm0_lpd_interconnect_M07_AXI_BVALID;
  wire [31:0]axi_hpm0_lpd_interconnect_M07_AXI_RDATA;
  wire axi_hpm0_lpd_interconnect_M07_AXI_RREADY;
  wire [1:0]axi_hpm0_lpd_interconnect_M07_AXI_RRESP;
  wire axi_hpm0_lpd_interconnect_M07_AXI_RVALID;
  wire [31:0]axi_hpm0_lpd_interconnect_M07_AXI_WDATA;
  wire axi_hpm0_lpd_interconnect_M07_AXI_WREADY;
  wire [3:0]axi_hpm0_lpd_interconnect_M07_AXI_WSTRB;
  wire axi_hpm0_lpd_interconnect_M07_AXI_WVALID;
  wire [8:0]axi_sysid_0_rom_addr;
  wire [15:0]data_in_rx_0_1;
  wire [15:0]data_in_rx_1_1;
  wire [15:0]data_in_rx_2_1;
  wire [15:0]data_in_rx_3_1;
  wire [15:0]data_in_tx_0_1;
  wire [15:0]data_in_tx_1_1;
  wire [15:0]data_in_tx_2_1;
  wire [15:0]data_in_tx_3_1;
  wire data_valid_in_rx_0_1;
  wire data_valid_in_tx_0_1;
  wire [94:0]gpio_i;
  wire [94:0]gpio_o;
  ...
  wire spi0_mosi;
  wire spi0_sclk;
  wire [15:0]sync_input_data_out_rx_0;
  wire [15:0]sync_input_data_out_rx_1;
  wire [0:0]sync_input_data_valid_out_rx_0;
  wire [15:0]sync_output_data_out_rx_0;
  wire [15:0]sync_output_data_out_rx_1;
  wire [15:0]sync_output_data_out_rx_2;
  wire [15:0]sync_output_data_out_rx_3;
  wire [15:0]sync_output_data_out_tx_0;
  wire [15:0]sync_output_data_out_tx_1;
  wire [15:0]sync_output_data_out_tx_2;
  wire [15:0]sync_output_data_out_tx_3;
  wire [0:0]sync_output_data_valid_out_rx_0;
  wire [0:0]sync_output_data_valid_out_tx_0;
  wire sys_250m_clk;
  ...
  system_Receiver_ip_0_0 Receiver_ip_0
       (.AXI4_Lite_ACLK(axi_adrv9001_dac_1_clk),
        .AXI4_Lite_ARADDR(axi_hpm0_lpd_interconnect_M07_AXI_ARADDR),
        .AXI4_Lite_ARESETN(tx_rstn_inverter_Res),
        .AXI4_Lite_ARREADY(axi_hpm0_lpd_interconnect_M07_AXI_ARREADY),
        .AXI4_Lite_ARVALID(axi_hpm0_lpd_interconnect_M07_AXI_ARVALID),
        .AXI4_Lite_AWADDR(axi_hpm0_lpd_interconnect_M07_AXI_AWADDR),
        .AXI4_Lite_AWREADY(axi_hpm0_lpd_interconnect_M07_AXI_AWREADY),
        .AXI4_Lite_AWVALID(axi_hpm0_lpd_interconnect_M07_AXI_AWVALID),
        .AXI4_Lite_BREADY(axi_hpm0_lpd_interconnect_M07_AXI_BREADY),
        .AXI4_Lite_BRESP(axi_hpm0_lpd_interconnect_M07_AXI_BRESP),
        .AXI4_Lite_BVALID(axi_hpm0_lpd_interconnect_M07_AXI_BVALID),
        .AXI4_Lite_RDATA(axi_hpm0_lpd_interconnect_M07_AXI_RDATA),
        .AXI4_Lite_RREADY(axi_hpm0_lpd_interconnect_M07_AXI_RREADY),
        .AXI4_Lite_RRESP(axi_hpm0_lpd_interconnect_M07_AXI_RRESP),
        .AXI4_Lite_RVALID(axi_hpm0_lpd_interconnect_M07_AXI_RVALID),
        .AXI4_Lite_WDATA(axi_hpm0_lpd_interconnect_M07_AXI_WDATA),
        .AXI4_Lite_WREADY(axi_hpm0_lpd_interconnect_M07_AXI_WREADY),
        .AXI4_Lite_WSTRB(axi_hpm0_lpd_interconnect_M07_AXI_WSTRB),
        .AXI4_Lite_WVALID(axi_hpm0_lpd_interconnect_M07_AXI_WVALID),
        .IPCORE_CLK(axi_adrv9001_dac_1_clk),
        .IPCORE_RESETN(tx_rstn_inverter_Res),
        .dut_data_in_0_rx(sync_input_data_out_rx_0),
        .dut_data_in_1_rx(sync_input_data_out_rx_1),
        .dut_data_out_0_rx(Receiver_ip_0_dut_data_out_0_rx),
        .dut_data_out_1_rx(Receiver_ip_0_dut_data_out_1_rx),
        .dut_data_out_2_rx(Receiver_ip_0_dut_data_out_2_rx),
        .dut_data_out_3_rx(Receiver_ip_0_dut_data_out_3_rx),
        .dut_data_valid_in_rx(sync_input_data_valid_out_rx_0),
        .dut_data_valid_out_rx(Receiver_ip_0_dut_data_valid_out_rx));
  assign VCC_1_dout = 1'h1;
  system_axi_adrv9001_0 axi_adrv9001
       (.adc_1_clk(axi_adrv9001_adc_1_clk),
        .adc_1_data_i0(data_in_rx_0_1),
        .adc_1_data_i1(data_in_rx_1_1),
        .adc_1_data_q0(data_in_rx_2_1),
        .adc_1_data_q1(data_in_rx_3_1),
        ...
        .adc_1_valid_i0(data_valid_in_rx_0_1),
        ...
        .dac_1_data_i0(sync_output_data_out_tx_0),
        .dac_1_data_i1(sync_output_data_out_tx_1),
        .dac_1_data_q0(sync_output_data_out_tx_2),
        .dac_1_data_q1(sync_output_data_out_tx_3),
        ...
        .dac_1_valid_i0(data_valid_in_tx_0_1),
  ...
  system_axi_hpm0_lpd_interconnect_0 axi_hpm0_lpd_interconnect
       (.M00_AXI_araddr(axi_hpm0_lpd_interconnect_M00_AXI_ARADDR),
        ...
        .M07_AXI_araddr(axi_hpm0_lpd_interconnect_M07_AXI_ARADDR),
        .M07_AXI_arready(axi_hpm0_lpd_interconnect_M07_AXI_ARREADY),
        .M07_AXI_arvalid(axi_hpm0_lpd_interconnect_M07_AXI_ARVALID),
        .M07_AXI_awaddr(axi_hpm0_lpd_interconnect_M07_AXI_AWADDR),
        .M07_AXI_awready(axi_hpm0_lpd_interconnect_M07_AXI_AWREADY),
        .M07_AXI_awvalid(axi_hpm0_lpd_interconnect_M07_AXI_AWVALID),
        .M07_AXI_bready(axi_hpm0_lpd_interconnect_M07_AXI_BREADY),
        .M07_AXI_bresp(axi_hpm0_lpd_interconnect_M07_AXI_BRESP),
        .M07_AXI_bvalid(axi_hpm0_lpd_interconnect_M07_AXI_BVALID),
        .M07_AXI_rdata(axi_hpm0_lpd_interconnect_M07_AXI_RDATA),
        .M07_AXI_rready(axi_hpm0_lpd_interconnect_M07_AXI_RREADY),
        .M07_AXI_rresp(axi_hpm0_lpd_interconnect_M07_AXI_RRESP),
        .M07_AXI_rvalid(axi_hpm0_lpd_interconnect_M07_AXI_RVALID),
        .M07_AXI_wdata(axi_hpm0_lpd_interconnect_M07_AXI_WDATA),
        .M07_AXI_wready(axi_hpm0_lpd_interconnect_M07_AXI_WREADY),
        .M07_AXI_wstrb(axi_hpm0_lpd_interconnect_M07_AXI_WSTRB),
        .M07_AXI_wvalid(axi_hpm0_lpd_interconnect_M07_AXI_WVALID),
  ...
  system_rx_rstn_inverter_0 rx_rstn_inverter
       (.Op1(axi_adrv9001_adc_1_rst),
        .Res(rx_rstn_inverter_Res));
  sync_input_imp_13CLUWH sync_input
       (.data_in_rx_0(data_in_rx_0_1),
        .data_in_rx_1(data_in_rx_1_1),
        .data_in_rx_2(data_in_rx_2_1),
        .data_in_rx_3(data_in_rx_3_1),
        .data_in_tx_0(data_in_tx_0_1),
        .data_in_tx_1(data_in_tx_1_1),
        .data_in_tx_2(data_in_tx_2_1),
        .data_in_tx_3(data_in_tx_3_1),
        .data_out_rx_0(sync_input_data_out_rx_0),
        .data_out_rx_1(sync_input_data_out_rx_1),
        .data_valid_in_rx_0(data_valid_in_rx_0_1),
        .data_valid_in_tx_0(data_valid_in_tx_0_1),
        .data_valid_out_rx_0(sync_input_data_valid_out_rx_0),
        .rx_clk(axi_adrv9001_adc_1_clk),
        .rx_rstn(rx_rstn_inverter_Res),
        .tx_clk(axi_adrv9001_dac_1_clk),
        .tx_rstn(tx_rstn_inverter_Res));
  sync_output_imp_1NKHJQ6 sync_output
       (.data_in_rx_0(Receiver_ip_0_dut_data_out_0_rx),
        .data_in_rx_1(Receiver_ip_0_dut_data_out_1_rx),
        .data_in_rx_2(Receiver_ip_0_dut_data_out_2_rx),
        .data_in_rx_3(Receiver_ip_0_dut_data_out_3_rx),
        .data_in_tx_0({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .data_in_tx_1({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .data_in_tx_2({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .data_in_tx_3({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .data_out_rx_0(sync_output_data_out_rx_0),
        .data_out_rx_1(sync_output_data_out_rx_1),
        .data_out_rx_2(sync_output_data_out_rx_2),
        .data_out_rx_3(sync_output_data_out_rx_3),
        .data_out_tx_0(sync_output_data_out_tx_0),
        .data_out_tx_1(sync_output_data_out_tx_1),
        .data_out_tx_2(sync_output_data_out_tx_2),
        .data_out_tx_3(sync_output_data_out_tx_3),
        .data_valid_in_rx_0(Receiver_ip_0_dut_data_valid_out_rx),
        .data_valid_in_tx_0(1'b0),
        .data_valid_out_rx_0(sync_output_data_valid_out_rx_0),
        .data_valid_out_tx_0(sync_output_data_valid_out_tx_0),
        .rx_clk(axi_adrv9001_adc_1_clk),
        .rx_rstn(rx_rstn_inverter_Res),
        .tx_clk(axi_adrv9001_dac_1_clk),
        .tx_rstn(tx_rstn_inverter_Res));
  ...
  system_tx_rstn_inverter_0 tx_rstn_inverter
       (.Op1(axi_adrv9001_dac_1_rst),
        .Res(tx_rstn_inverter_Res));
  system_util_adc_1_pack_0 util_adc_1_pack
       (.clk(axi_adrv9001_adc_1_clk),
        ...
        .fifo_wr_data_0(sync_output_data_out_rx_0),
        .fifo_wr_data_1(sync_output_data_out_rx_1),
        .fifo_wr_data_2(sync_output_data_out_rx_2),
        .fifo_wr_data_3(sync_output_data_out_rx_3),
        .fifo_wr_en(sync_output_data_valid_out_rx_0),
  ...
  system_util_dac_1_upack_0 util_dac_1_upack
       (.clk(axi_adrv9001_dac_1_clk),
        ...
        .fifo_rd_data_0(data_in_tx_0_1),
        .fifo_rd_data_1(data_in_tx_1_1),
        .fifo_rd_data_2(data_in_tx_2_1),
        .fifo_rd_data_3(data_in_tx_3_1),
        .fifo_rd_en(sync_output_data_valid_out_tx_0),
