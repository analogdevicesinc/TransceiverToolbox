...
## Define the ADI_SKIP_SYNTHESIS environment variable to skip the synthesis
if {[info exists ::env(ADI_SKIP_SYNTHESIS)]} {
  set ADI_SKIP_SYNTHESIS 1
} elseif {![info exists ADI_SKIP_SYNTHESIS]} {
  set ADI_SKIP_SYNTHESIS 0
}
...
proc adi_project_run {project_name} {
  ...
  ## end of Extract IP ports and their properties
...
proc adi_project_synth {project_name prcfg_name hdl_files {xdc_files ""}} {
  ...
  global p_device
  global ADI_SKIP_SYNTHESIS

  if {$ADI_SKIP_SYNTHESIS == 1} {
    puts "INFO: Synthesis skipped."
    return
  }
