...
%     'PortName',       'dma_rdy', ...
%     'PortWidth',      1, ...
%     'InterfaceConnection', 'cpack/adc_valid', ...
%     'IsRequired',     false);
...
if contains(lower(type),'rx')
    hRD.addInternalIOInterface( ...
        ...
        'InterfaceType',  'OUT', ...
        'PortName',       'dut_data_valid_out', ...
        'PortWidth',      1, ...
        'InterfaceConnection', 'cpack/fifo_wr_en', ...
        'IsRequired',     false);
    
    hRD.addInternalIOInterface( ...
        'InterfaceID',    'IP Valid Rx Data IN', ...
        'InterfaceType',  'IN', ...
        'PortName',       'dut_data_valid_in', ...
        'PortWidth',      1, ...
    ...
    hRD.addInternalIOInterface( ...
        ...
        'PortName',       'dut_data_0', ...
        'PortWidth',      16, ...
        'InterfaceConnection', 'cpack/fifo_wr_data_0', ...
        'IsRequired',     false);
    ...
    hRD.addInternalIOInterface( ...
        ...
        'PortName',       'dut_data_1', ...
        'PortWidth',      16, ...
        'InterfaceConnection', 'cpack/fifo_wr_data_1', ...
        'IsRequired',     false);
...
if contains(lower(type),'tx')
    ...
    hRD.addInternalIOInterface( ...
        ...
        'PortWidth',      16, ...
        'InterfaceConnection', 'tx_upack/fifo_rd_data_0', ...
        'IsRequired',     false);
    ...
    hRD.addInternalIOInterface( ...
        ...
        'PortWidth',      16, ...
        'InterfaceConnection', 'tx_upack/fifo_rd_data_1', ...
        'IsRequired',     false);
    ...
    hRD.addInternalIOInterface( ...
        ...
        'PortWidth',      1, ...
        'InterfaceConnection', 'logic_or/Op1', ...
        'IsRequired',     false);
    ...
    hRD.addInternalIOInterface( ...
        ...
        'PortWidth',      1, ...
        'InterfaceConnection', 'tx_upack/fifo_rd_valid', ...
        'IsRequired',     false);
end