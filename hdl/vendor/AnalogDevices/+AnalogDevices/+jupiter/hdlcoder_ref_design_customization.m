...
rd = {...
    'AnalogDevices.jupiter.plugin_rd_rx', ...
    'AnalogDevices.jupiter.plugin_rd_tx', ...
    'AnalogDevices.jupiter.plugin_rd_rxtx', ...
	'AnalogDevices.jupiter.plugin_rd_txrx', ...
    'AnalogDevices.jupiter.plugin_rd_rxtx_byte', ...
    };

boardName = 'AnalogDevices JUPITER';
