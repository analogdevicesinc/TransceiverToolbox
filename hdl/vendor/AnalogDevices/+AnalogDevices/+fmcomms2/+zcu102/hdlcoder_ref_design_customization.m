function [rd, boardName] = hdlcoder_ref_design_customization
    ...
    rd = { ...
          'AnalogDevices.fmcomms2.zcu102.plugin_rd_rx', ...
          'AnalogDevices.fmcomms2.zcu102.plugin_rd_tx', ...
          'AnalogDevices.fmcomms2.zcu102.plugin_rd_rxtx' ...
         };

    boardName = 'AnalogDevices FMCOMMS2/3 ZCU102';
