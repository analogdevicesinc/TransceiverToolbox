...
hRD.ReferenceDesignName = sprintf('FMCOMMS5 %s (%s)', upper(board), upper(design));
...
hRD.addCustomVivadoDesign( ...
    'CustomBlockDesignTcl', fullfile('projects', 'fmcomms5', lower(board), 'system_project_rxtx.tcl'), ...
