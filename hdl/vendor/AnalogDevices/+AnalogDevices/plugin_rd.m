...
if strcmpi(project, 'pluto') || strcmpi(project, 'jupiter')
...
elseif contains(project, 'jupiter')
    hRD.addCustomVivadoDesign( ...
        'CustomBlockDesignTcl', fullfile('projects', 'scripts', 'system_project_rxtx.tcl'), ...
        'CustomTopLevelHDL',    fullfile('projects', 'jupiter_sdr', 'system_top.v'));
else
    hRD.addCustomVivadoDesign( ...
        'CustomBlockDesignTcl', fullfile('projects', 'scripts', 'system_project_rxtx.tcl'), ...
...
elseif contains(project, 'jupiter')
    hRD.CustomConstraints = {...
        fullfile('projects', 'jupiter_sdr', 'system_constr.xdc'), ...
        ...%fullfile('projects', 'common', lower(board), sprintf('%s_system_constr.xdc', lower(board))), ...
        };
else
    hRD.CustomConstraints = {...
...
if strcmpi(project, 'adrv9002') || strcmpi(project, 'jupiter')
