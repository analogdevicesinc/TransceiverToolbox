function [rd, boardName] = hdlcoder_ref_design_customization
    ...
    rd = { ...
          'AnalogDevices.fmcomms8.zcu102.plugin_rd_rx', ...
          'AnalogDevices.fmcomms8.zcu102.plugin_rd_tx' ...
          ...%     'AnalogDevices.fmcomms8.zcu102.plugin_rd_rxtx', ...
         };

    boardName = 'AnalogDevices FMCOMMS8 ZCU102';
